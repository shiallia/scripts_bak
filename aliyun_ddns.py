'''
自动获取自己的外网ip，每隔一段时间调用阿里云接口，将某域名指向该ip

依赖
* python包:aliyun-python-sdk-alidns  
* curl
'''
...
def my_ip_method_1():
    get_ip_method = os.popen('curl -s http://pv.sohu.com/cityjson?ie=utf-8')
